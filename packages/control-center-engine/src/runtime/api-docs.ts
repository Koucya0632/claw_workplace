  ...
  return {
    ...
    routes: [
      ...
      },
      {
        ...
        summary: "Role-grouped staff summary for the web Control Center staff page",
        response: {
          ok: "boolean",
          generatedAt: "ISO timestamp",
          groups: "Array<{ roleKey, roleLabel, count, members[] }>",
          sessionsDetail: "{ count, sessions[] }",
        },
      },
      {
        method: "GET",
        path: "/api/budget/template",
        summary: "Return a minimal global monthly budget config template for Usage setup",
        response: {
          ok: "boolean",
          template: "{ monthlyCostLimitUsd }",
          hint: "string",
        },
      },
      {
